...
function Comments ({articleId}) {
    ...
    const LoadCommentsButtonClasses = moreCommenntsAvailable? "load-comment-button" : "load-comment-button disabled-button"
...
<button onClick={loadMoreComments} className={LoadCommentsButtonClasses}>Load more</button>
    </div>
</>
}
